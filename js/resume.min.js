document.addEventListener('DOMContentLoaded', () => {
    ...
    const CONFIG = {
        ...
        videoFrames: document.querySelectorAll('.video-frame') // 👈 NUEVO
    };

    // --- 2. OPTIMIZACIÓN INICIAL DE VIDEOS ---
  ...
  const content = document.querySelector('.bio-hidden-content');

  btn.addEventListener('click', () => {
    // Verificamos si el contenido está oculto
    if (content.style.display === 'none') {
      content.style.display = 'block';   // Lo mostramos
      btn.textContent = 'See Less';      // Opcional: cambiamos el texto
    } else {
      content.style.display = 'none';    // Lo ocultamos
